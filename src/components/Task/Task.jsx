...
function Task({ id, text, completed, onComplete, list, onRename, onDelete }) {
    const onChangeCheckbox = event => {
        onComplete(list.id, id, event.target.checked)
    }

    const onClickRename = () => {
        onRename(list.id, { id, text })
    }
